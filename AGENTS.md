...
- Use `./scripts/pnpm` instead of invoking pnpm directly. The repo pins `pnpm@10.25.0`; the wrapper uses an existing repo-local cache, an exact global installation, or Corepack in that order.
